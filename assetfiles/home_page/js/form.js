...
(() => {
    ...
    cf.setAttribute("data-api-token", be);
	...
	(t => {
		...
		e("form[data-api-token]").forEach((t => l(t)))
	}));
	const c = {
	...
	const l = (r, o) => {
			...
			const c = [],
				...
				b = cf.getAttribute("data-api-token")
			"API_TOKEN" === b && (d = !1, null);
					...
					return n = void 0, i = void 0, a = function*() {
						...
						try {
							console.log(u(E)), d ? yield(n = {
								...
								const e = yield((e, n) => t(void 0, void 0, void 0, (function*() {
									...
									const t = JSON.stringify(n),
										i = new Headers({
                                            ...
                                            "X-CSRFToken": cf.getAttribute("csrf-token")
										}),
										s = yield fetch(protocol + '//'+ window.location.host + '/' + 'contact-api/', {
											method: "POST",
											headers: i,
								...
								return yield e.json()
							}))): null, f.classList.remove("d-none"), E.forEach((t => {
