"""
Django settings for rbzk project.
...
WSGI_APPLICATION = 'rbzk.wsgi.application'
...
CELERY_WORKER_MAX_MEMORY_PER_CHILD = 100_000_000  # 100MB per child
CELERY_WORKER_MAX_TASKS_PER_CHILD = 50  # Restart after 100 tasks
